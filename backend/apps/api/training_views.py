...
def run_training(job_id, dataset_path, model_type, target_column):
    ...
    try:
        ...
        job.result = {
            ...
            "class_weights": metadata.get("class_weights") or {},
            "weighting_method": metadata.get("weighting_method") or metrics.get("weighting_method"),
            "selected_threshold": metadata.get("selected_threshold"),
            "threshold_selection": metadata.get("threshold_selection") or {},
            "calibration": metadata.get("calibration") or {},
            "final_test_metrics": metadata.get("final_test_metrics") or {},
            "subgroup_report": metadata.get("subgroup_report") or [],
