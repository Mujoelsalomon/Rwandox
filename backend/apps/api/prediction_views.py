...
<body>
  <main class="report">
    <header class="header">
      {f'<img class="logo" src="{escape(logo_data_url)}" alt="Model logo" />' if logo_data_url else ''}
      <div>
    ...
    <p class="footer">Generated by the postoperative oxygen requirement prediction model.</p>
  </main>
</body>
</html>"""
