...
def patient_payload(patient):
    ...
    return {
        ...
        "raw_probability": latest_prediction.raw_probability if latest_prediction else None,
        "calibrated_probability": latest_prediction.calibrated_probability if latest_prediction else None,
        "display_probability": latest_prediction.display_probability if latest_prediction else "",
