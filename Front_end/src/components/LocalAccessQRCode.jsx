  ...
  return (
    <div className="mt-5 grid min-w-0 gap-4 xl:grid-cols-[minmax(0,0.95fr)_minmax(300px,0.75fr)]">
      <section className="card border-0 shadow-sm rounded-4 min-w-0 rounded-[14px] border border-[#d9e5f3] bg-white p-4 md:p-5">
        <p className="small-text text-primary fw-bold text-uppercase mb-2 font-black tracking-[0.18em]">QR-code access</p>
        <h2 className="section-title font-black text-[#071b49]">Local Access QR Code</h2>
        ...
        <div className="mt-5 rounded-[12px] border border-[#d9e5f3] bg-[#f8fbff] p-4">
          <p className="table-header mb-2 font-black uppercase tracking-[0.12em] text-[#64799e]">QR opens</p>
        ...
        <div className="mt-3 rounded-[12px] border border-[#d9e5f3] bg-white p-4">
          <p className="table-header mb-2 font-black uppercase tracking-[0.12em] text-[#64799e]">Backend auto-used</p>
