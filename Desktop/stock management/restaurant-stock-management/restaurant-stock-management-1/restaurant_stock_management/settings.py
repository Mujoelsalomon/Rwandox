"""
Django settings for restaurant_stock_management project.
...
ROOT_URLCONF = 'restaurant_stock_management.urls'
...
WSGI_APPLICATION = 'restaurant_stock_management.wsgi.application'
